        ...
        >
          <Grid item columnGap={"24px"} marginBottom={"24px"} sm={6} xs={12} md={3}>
            <Box display={"flex"} flexDirection="column" alignItems="center" rowGap="16px">
              ...
              <Link
                href="https://twitter.com/SynapseNODE"
                target="_blank"
              ...
              <Link href="https://t.me/node_synapse" target="_blank" rel="noopener noreferrer" className="link-text">
                Telegram
              </Link>
              <Link
          ...
          <Grid item columnGap={"24px"} marginBottom={"24px"} sm={6} xs={12} md={3}>
            <Box display={"flex"} flexDirection="column" alignItems="center" rowGap="16px">
              ...
              <Link href="http://medium.com/@SynapseNODE" target="_blank" rel="noopener noreferrer" className="link-text">
                Medium
              </Link>
            </Box>
          </Grid>
